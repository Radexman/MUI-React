	...
	return (
		<div>
			...
			>
				...
				<AccordionDetails>
					<Typography>
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi alias incidunt est minus sunt.
						Quos, nisi error tempore laboriosam quaerat voluptatibus adipisci ipsum dolores neque!
					</Typography>
				</AccordionDetails>
			</Accordion>
			<Accordion
